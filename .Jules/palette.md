...
## 2024-05-26 - UX Tooltips for Bulk Actions in Streamlit
**Learning:** For destructive or wide-impact actions like bulk edits, adding `help` tooltips and `placeholder` text provides a clear explanation and prevents accidental data loss. This was highly effective.
**Action:** Always add explicit tooltips to destructive bulk-edit buttons and inputs that could clear data.
